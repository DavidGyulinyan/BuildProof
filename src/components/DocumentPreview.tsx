...
export default function DocumentPreview({ pageIndex, previewId = "document-preview" }: DocumentPreviewProps = {}) {
        ...
        <div id={previewId} className="w-[794px] min-h-[1123px] text-[13px] flex flex-col gap-2 border border-black p-7 bg-white">
            ...
            <div className="container w-full flex flex-col justify-center items-start">
                ...
                <p className="text-[10px] font-thin flex justify-center gap-2">2.1․ Ներկայացված աշխատանքները
                    համապատասխանում են <span className="font-bold underline">շին. նորմերին և նախագծին</span></p>
